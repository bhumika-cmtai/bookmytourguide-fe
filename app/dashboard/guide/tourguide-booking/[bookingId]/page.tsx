...
import { Loader2, AlertCircle, ChevronLeft, User, Calendar, MapPin, DollarSign, Languages } from 'lucide-react';
          ...
          <Separator />
           <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-4">
               ...
               <div className="space-y-4">
                <h3 className="font-semibold flex items-center text-lg"><DollarSign className="w-5 h-5 mr-3 text-primary" />Payment Details</h3>
