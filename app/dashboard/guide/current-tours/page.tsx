// app/dashboard/guide/current-tours/page.tsx
"use client";
...
// --- UPDATED TOUR DETAIL SHEET COMPONENT ---
// This version now shows a "Fully Paid" status.
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-3">
                                ...
                                <div className="flex justify-between items-center text-green-600 font-bold text-lg">
                                    <span className="flex items-center gap-2"><CheckCircle className="w-5 h-5"/>Status</span>
...
// --- MAIN PAGE COMPONENT ---
export default function GuideCurrentToursPage() {
  ...
  const populatedBookings = useMemo(() => {
    return allBookings
      ...
      // --- KEY CHANGE: Only show "Upcoming" tours ---
      ...
      <main className="pt-10">
        <section className="py-10 bg-card border-b">
          <div className="container max-w-7xl mx-auto px-4">
            {/* Title updated to be more specific */}
            <h1 className="text-4xl font-extrabold">My Upcoming Tours</h1>
            <p className="mt-2 text-lg text-muted-foreground">Manage your upcoming and confirmed tour assignments.</p>
          </div>
        </section>
        ...
        <section className="py-8">
          <div className="container max-w-7xl mx-auto px-4">
            <Card className="mb-8">
              <CardHeader>
                {/* Search bar is kept, but the status filter is removed as it's no longer needed */}
              ...
              {filteredBookings.length > 0 ? filteredBookings.map(item => (
                <Card key={item._id} className="overflow-hidden">
                  <div className="p-6 flex flex-col sm:flex-row justify-between gap-4">
                    ...
                    {/* --- KEY CHANGE: "Cancel Trip" button is removed --- */}
