...
export const LanguageProvider = ({ children }: { children: ReactNode }) => {
  ...
  const t = useCallback(
    (
      ...
      const translations: Record<LanguageCode, Record<string, string>> = {
        ...
        en: {
          ...
          find_guides_card_title: "Discover Your Guide",
          ...
          guide_page_title: "Become a BookMyTourGuide Partner",
          guide_page_desc:
          ...
          guide_page_cta_button: "Become a Verified Certified Tour Guide",
          // ================================= HOW IT WORKS PAGE =================================
          ...
          how_step_1_detail_1: "Filter by tour type, location, and price",
          how_step_1_detail_2: "Read guide profiles and reviews",
          ...
          how_payment_step_3_timing: "After tour",
          ...
          contact_map_office_name: "BookMyTourGuide Head Office",
    ...
    contact_desc: "¿Tienes preguntas o comentarios? Contáctanos y haremos que tu experiencia de viaje sea perfecta.",
    ...
    contact_form_card_desc: "Rellena el formulario y te responderemos en 24 horas",
    contact_form_success_title: "¡Mensaje Enviado!",
    contact_form_success_desc: "Gracias por contactarnos. Te responderemos en breve.",
    contact_form_error_title: "Error",
    ...
    contact_form_message_placeholder: "Por favor, proporciona detalles sobre tu consulta...",
    ...
    contact_desc: "Des questions ou des commentaires ? Contactez-nous pour une expérience de voyage fluide.",
    ...
    contact_form_card_desc: "Remplissez le formulaire ci-dessous et nous vous répondrons sous 24 heures",
    ...
    contact_form_message_label: "Message *",
    contact_form_message_placeholder: "Veuillez fournir des détails sur votre demande...",
    ...
    contact_desc: "Есть вопросы или отзывы? Свяжитесь с нами, и мы сделаем ваше путешествие безупречным.",
    ...
    contact_form_card_desc: "Заполните форму ниже, и мы свяжемся с вами в течение 24 часов",
    contact_form_success_title: "Сообщение отправлено!",
    contact_form_success_desc: "Спасибо, что связались с нами. Мы скоро ответим.",
    ...
    contact_form_message_placeholder: "Пожалуйста, предоставьте детали...",
